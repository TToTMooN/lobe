...
| **X-VLA** | **ours v1.3 (V17b)** | 0.9B | **91.25%** | 89 | 97 | 89 | **90** | V16 + eval tweak | V16 checkpoint with eval-time `num_denoising_steps=20` (was 10). libero_10 +7 from more accurate long-horizon chunks via doubled flow-matching ODE refinement. Gap to paper: **6.85 pp**. |
