...
PRESETS = {
    "aloha-fm": (
        ...
        TrainPipelineConfig(
            ...
            policy=FMPolicyConfig(backbone="transformer", num_inference_steps=6, resize_shape="224,224"),
    ...
    "aloha-fm-fast": (
        ...
        TrainPipelineConfig(
            ...
            policy=FMPolicyConfig(backbone="transformer", num_inference_steps=6),
            train=TrainConfig(steps=25000, batch_size=256),
            performance=PerformanceConfig(num_workers=0),
            logging=LoggingConfig(output_dir="checkpoints/aloha_fm", save_every=5000),
        ),
    ...
    "aloha-fm-delta": (
        ...
        TrainPipelineConfig(
            ...
            policy=FMPolicyConfig(backbone="transformer", num_inference_steps=6, delta_actions=True),
            train=TrainConfig(steps=25000, batch_size=256),
            performance=PerformanceConfig(num_workers=0),
