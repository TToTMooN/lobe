...
# NOTE: Registration happens via lerobot's bundled copy (imported in lobe/__init__.py).
# This local copy is for reading/modification. To use your modified version instead:
#   1. Remove the X-VLA imports from lobe/__init__.py (the lerobot ones)
#   2. Uncomment the @register_subclass line below
#   3. Add `import lobe.policies.xvla.configuration_xvla` to lobe/__init__.py
